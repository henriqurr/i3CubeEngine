...
namespace i3CubeEngine
{
    ...
    public static class ShellIcon
    {
        ...
        public static Icon GetSmallIcon(string fileName) => GetIcon(fileName, Win32.FILE_ATTRIBUTE_NORMAL, Win32.SHGFI_SMALLICON);
        ...
        private static Icon GetIcon(string fileName, uint dwAttributes, uint flags)
        {
            ...
            IntPtr hImgSmall = Win32.SHGetFileInfo(fileName, dwAttributes, ref shinfo, (uint)Marshal.SizeOf(shinfo), Win32.SHGFI_ICON | flags);
